...
@pytest.mark.asyncio
async def test_create_fleet(name:str,description:str,id:int,test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_create_fleet_with_same_name(name:str,description:str,id:int,test_session:AsyncSession)->None:
    fleet = schemas.FleetCreate(name = name, description=description)
    response = await create_obj(Fleet,test_session,**fleet.dict())
    assert response.id == id
    assert response.name == name
...
async def test_create_fleet_with_none_name(name:str,description:str,id:int,test_session:AsyncSession)->None:
...
async def test_create_fleet_with_none_description(name:str,description:str,id:int,test_session:AsyncSession)->None:
    fleet = schemas.FleetCreate(name = name, description=description)
    response = await create_obj(Fleet,test_session,**fleet.dict())
    assert response.id == id
    assert response.name == name
...
async def test_create_fleet_with_none_name_and_none_description(name:str,description:str,id:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        fleet = schemas.FleetCreate(name = name, description=description)
        await create_obj(Fleet,test_session,**fleet.dict())
...
@pytest.mark.asyncio
async def test_create_vehicle(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_create_vehicle_with_same_name(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
    vehicle = schemas.VehicleCreate(name= name, description=description,fleet_id = fleet_id)
    response = await create_obj(Vehicle,test_session,**vehicle.dict())
    assert response.id == id
    assert response.name == name
...
async def test_create_vehicle_with_none_name(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        vehicle = schemas.VehicleCreate(name= name, description=description,fleet_id = fleet_id)
...
async def test_create_vehicle_with_none_description(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
    vehicle = schemas.VehicleCreate(name= name, description=description,fleet_id = fleet_id)
    response = await create_obj(Vehicle,test_session,**vehicle.dict())
    assert response.id == id
    assert response.name == name
...
async def test_create_vehicle_with_none_fleet_id(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        vehicle = schemas.VehicleCreate(name= name, description=description,fleet_id = fleet_id)
        await create_obj(Vehicle,test_session,**vehicle.dict())
...
@pytest.mark.parametrize("name, description,fleet_id,id", [
    (None, None, None,6)])
async def test_create_vehicle_with_none_name_and_none_description(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        vehicle = schemas.VehicleCreate(name= name, description=description,fleet_id = fleet_id)
        await create_obj(Vehicle,test_session,**vehicle.dict())
...
async def test_create_vehicle_with_fleet_id_not_exist(name:str, description:str, fleet_id:int, id:int, test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_create_driver(name:str, age:str, id:int, test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_create_driver_with_same_name(name:str, age:str, id:int, test_session:AsyncSession)->None:
    driver = schemas.DriverCreate(name=name, age=datetime.strptime(age,"%Y-%m-%d"))
    response = await create_obj(Driver,test_session,**driver.dict())
    assert response.id == id
    assert response.name == name
...
@pytest.mark.parametrize("name,age,id", [
    (None, '1988-05-13',5)])
async def test_create_driver_with_none_name(name:str, age:str, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        driver = schemas.DriverCreate(name=name, age=datetime.strptime(age,"%Y-%m-%d"))
...
async def test_create_driver_with_none_age(name:str, age:str, id:int, test_session:AsyncSession)->None:
...
@pytest.mark.parametrize("name,age,id", [
    (None, None,6)])
async def test_create_driver_with_none_name_and_none_age(name:str, age:str, id:int, test_session:AsyncSession)->None:
    with pytest.raises(TypeError):
        driver = schemas.DriverCreate(name=name, age=datetime.strptime(age,"%Y-%m-%d"))
        await create_obj(Driver,test_session,**driver.dict())
...
@pytest.mark.asyncio
async def test_create_route(name:str, description:str, id:int, test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_create_route_with_same_name(name:str, description:str, id:int, test_session:AsyncSession)->None:
    route = schemas.RouteCreate(name=name, description=description)
    response = await create_obj(Route,test_session,**route.dict())
    assert response.id == id
    assert response.name == name
...
async def test_create_route_with_none_name(name:str, description:str, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route = schemas.RouteCreate(name=name, description=description)
...
@pytest.mark.parametrize("name, description,id", [
    ("Test Route 5", None,5)])
async def test_create_route_with_none_description(name:str, description:str, id:int, test_session:AsyncSession)->None:
    route = schemas.RouteCreate(name=name, description=description)
    response = await create_obj(Route,test_session,**route.dict())
    assert response.id == id
    assert response.name == name
...
@pytest.mark.parametrize("name, description,id", [
    (None, None,6)])
async def test_create_route_with_none_name_and_none_description(name:str, description:str, id:int, test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route = schemas.RouteCreate(name=name, description=description)
        await create_obj(Route,test_session,**route.dict())
...
@pytest.mark.asyncio
async def test_create_route_details(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
...
async def test_create_route_detail_with_none_route_id(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route_detail = schemas.RouteDetailCreate(
            route_id=route_id,driver_id = driver_id, vehicle_id = vehicle_id, start_time = datetime.strptime(start_time,'%Y-%m-%dT%H:%M:%SZ'), end_time = datetime.strptime(end_time,'%Y-%m-%dT%H:%M:%SZ'),
...
async def test_create_route_detail_with_none_driver_id(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route_detail = schemas.RouteDetailCreate(
            route_id=route_id,driver_id = driver_id, vehicle_id = vehicle_id, start_time = datetime.strptime(start_time,'%Y-%m-%dT%H:%M:%SZ'), end_time = datetime.strptime(end_time,'%Y-%m-%dT%H:%M:%SZ'),
...
async def test_create_route_detail_with_start_time_is_another_date_format(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route_detail = schemas.RouteDetailCreate(
            route_id=route_id,driver_id = driver_id, vehicle_id = vehicle_id, start_time = datetime.strptime(start_time,'%Y-%m-%dT%H:%M:%SZ'), end_time = datetime.strptime(end_time,'%Y-%m-%dT%H:%M:%SZ'),
...
async def test_create_route_detail_with_start_time_have_not_time(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route_detail = schemas.RouteDetailCreate(
            route_id=route_id,driver_id = driver_id, vehicle_id = vehicle_id, start_time = datetime.strptime(start_time,'%Y-%m-%dT%H:%M:%SZ'), end_time = datetime.strptime(end_time,'%Y-%m-%dT%H:%M:%SZ'),
...
async def test_create_route_detail_with_route_id_is_not_int(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
    with pytest.raises(ValueError):
        route_detail = schemas.RouteDetailCreate(
            route_id=route_id,driver_id = driver_id, vehicle_id = vehicle_id, start_time = datetime.strptime(start_time,'%Y-%m-%dT%H:%M:%SZ'), end_time = datetime.strptime(end_time,'%Y-%m-%dT%H:%M:%SZ'),
...
@pytest.mark.fleet
@pytest.mark.asyncio
async def test_get_fleet_by_normalize_characters_not_in_name(test_session:AsyncSession)->None:
...
@pytest.mark.fleet
@pytest.mark.asyncio
async def test_get_fleet_by_special_characters_not_in_name(test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_get_fleet_by_id(id:int, name:str, description:str,test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_get_vehicle_by_id(id:int, name:str, description:str,fleet_id:int,test_session:AsyncSession)->None:
...
@pytest.mark.parametrize("name,age,id", [
    ...
    ("Test Driver 3", '1987-06-09',3)])
@pytest.mark.asyncio
async def test_get_driver_by_id(name:str, age:str, id:int,test_session:AsyncSession)->None:
...
@pytest.mark.asyncio
async def test_get_route_by_id(id:int, name:str, description:str,test_session:AsyncSession)->None:
...
@pytest.mark.parametrize("route_id,driver_id,vehicle_id,start_time,end_time,start_location,end_location,ticket_price", [
    ...
    (3, 3, 3, "2020-01-01T00:00:00Z", "2020-01-01T00:00:00Z", "Test Start Location 3", "Test End Location 3", 30)])
@pytest.mark.asyncio
async def test_get_route_detail_by_id(route_id:int,driver_id:int,vehicle_id:int,start_time : str,
end_time : str ,start_location:str,end_location:str,ticket_price:int,test_session:AsyncSession)->None:
...
(3,"Test Fleet 3","Test Fleet Description 3")])
@pytest.mark.asyncio
async def test_update_fleet_by_id(id:int, name:str, description:str,test_session:AsyncSession)->None:
    name = name + " Updated"
...
@pytest.mark.parametrize("id, name, description,fleet_id",
                         [(1,"Test Vehicle 1","Test Vehicle Description 1",1),
                          ...
                          (3,"Test Vehicle 3","Test Vehicle Description 3",3)])
@pytest.mark.asyncio
async def test_update_vehicle_by_id(id:int,name:str,description:str,fleet_id:int,test_session:AsyncSession)->None:
    name = name + " Updated"
...
@pytest.mark.asyncio
async def test_update_driver_by_id(id:int, name:str, age:str,test_session:AsyncSession)->None:
    name = name + " Updated"
...
(3,"Test Route 3","Test Route Description 3")])
@pytest.mark.asyncio
async def test_update_route_by_id(id:int, name:str, description:str,test_session:AsyncSession)->None:
    name = name + " Updated"
...
[(1,1),(2,2),(3,3)])
@pytest.mark.asyncio
async def test_delete_route_detail_by_id(route_id:int,vehicle_id:int,test_session:AsyncSession)->None:
